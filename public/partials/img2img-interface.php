...
function vortex_img2img_interface($args = array()) {
    ...
    wp_localize_script('vortex-img2img-interface-js', 'vortexImg2Img', array(
        ...
        'nonce' => wp_create_nonce('vortex_img2img_nonce'),
        'userId' => $user_id,
        ...
        'i18n' => array(
            'uploading' => __('Uploading image...', 'vortex'),
            'processing' => __('Processing transformation...', 'vortex'),
            'drawMask' => __('Draw mask on areas to edit', 'vortex'),
            'applyStyle' => __('Apply style to image', 'vortex')
        )
    ));
            ...
            <div class="vortex-img2img-canvas-area">
                ...
                <div class="vortex-canvas-actions" style="display: none;">
                    ...
                    <button type="button" class="vortex-action-btn vortex-use-as-source">
                        <?php esc_html_e('Use as Source', 'vortex'); ?>
                    </button>
