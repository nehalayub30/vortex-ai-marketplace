...
class VORTEX_License {
    ...
    private function load_dependencies() {
        // Commercial features
        require_once VORTEX_PLUGIN_FILE . 'includes/commercial/licensing/class-vortex-license-manager.php';
        require_once VORTEX_PLUGIN_FILE . 'includes/commercial/licensing/class-vortex-license-api.php';
        require_once VORTEX_PLUGIN_FILE . 'includes/commercial/licensing/class-vortex-update-manager.php';
        require_once VORTEX_PLUGIN_FILE . 'includes/commercial/licensing/class-vortex-subscription-manager.php';
    }
    ...
    public function license_page() {
        include VORTEX_PLUGIN_FILE . 'admin/partials/license-page.php';
    }
...
function vortex_license() {
    return VORTEX_License::get_instance();
}
